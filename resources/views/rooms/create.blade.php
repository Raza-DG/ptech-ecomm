...
<div class="d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Room Create</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <!--begin::Post-->
            <form class="form d-flex flex-column flex-lg-row gap-7 gap-lg-10" action="{{ route('rooms.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!--begin::Main column-->
                    ...
                    <div class="card card-flush py-4">
                            ...
                            <div class="mb-5 fv-row">
                                ...
                                <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid mb-5 d-block">
                                    <span class="form-check-label ms-0 fw-bolder fs-6 text-gray-700 ps-5">
                                        <input class="form-check-input" name="top_bar" type="checkbox" value="1" >
                                    </span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-5 fv-row">
                                ...
                                <select name="page_category_id" id="" class="form-select mb-2" data-control="select2" data-placeholder="Select an option" data-allow-clear="true" required>
                            ...
                            <div class="mb-5 fv-row">
                                ...
                                <select name="menu_id" class="form-select mb-2" data-control="select2" data-placeholder="Select an option" data-allow-clear="true" required>
                                    ...
                                    @foreach(\App\Models\Menu::where('menu_id',1)->where('parent_id', 0)->where('status','!=', 1)->get() as $menu)
                                        <option  value="{{ $menu->id }}" >{{ $menu->getTranslation("name") }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <!--begin::Input group-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-5 fv-row">
                                ...
                                <select class="form-select mb-2" data-control="select2" data-placeholder="Select an option" data-allow-clear="true" name="relative_ids[]" id="relative_ids" multiple  required>
                                    @foreach(App\Models\Room::all() as $relative)
                                        <option  value="{{ $relative->id }}" >{{ $relative->getTranslation("name") }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <!--begin::Input group-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-5 fv-row">
                                ...
                                <input type="text" placeholder="{{ translate('Relative Limit') }}" id="relative_limit" name="relative_limit" class="form-control mb-2" required>
                            </div>
                            <!--begin::Input group-->
                        </div>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-5 fv-row">
                                ...
                                <input type="text" placeholder="{{ translate('Relative Image Text') }}" id="relative_text" name="relative_text" class="form-control mb-2" required>
                            </div>
                            <!--begin::Input group-->
                        </div>
                            ...
                            <div class="fv-row mb-2">
                                ...
                                <div class="dropzone" id="kt_ecommerce_add_product_mediaa"
                                    ...
                                    <div class="dz-message needsclick">
                                        ...
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <input type="hidden" name="relative_image" class="selected-files" >
                                        <div class="ms-4">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="card-body pt-0">
                                <!--begin::Input group-->
                                <div class="mb-5 fv-row">
                                    <label class="required form-label">{{ translate('Slider Button') }}</label>
                                    <input type="text" placeholder="{{ translate('Slider Button') }}" id="slider_btn" name="slider_btn" class="form-control mb-2">
                            ...
                            <div class="card-body pt-0">
                                <!--begin::Input group-->
                                <div class="mb-5 fv-row">
                                    <label class="required form-label">{{ translate('Slider Button Link') }}</label>
                                    <input type="text" placeholder="{{ translate('Slider Button Link') }}" id="slider_btn_link" name="slider_btn_link" class="form-control mb-2">
                                </div>
