    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{translate("Inventory")}}</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">{{translate("eCommerce")}}</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-300 w-5px h-2px"></span>
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">{{translate("Inventory Receive")}}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6 text-center">
                                    <h4> {{translate("Tracking Number")}} # {{$inventory[0]->tracking_number}} </h4>
                                </div>
                                <div class="col-6 text-center">
                                    <h4> {{translate("Warehouse")}} : {{$inventory[0]->warehouse->name}} </h4>
                                    <h4> {{translate("Seller")}} : {{$inventory[0]->seller->user->name}} </h4>
                                </div>
                            </div>
                        </div>
                    </div>
