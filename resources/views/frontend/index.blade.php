...
@section('content')
    ...
    <article id="post-702" class="post-702 page type-page status-publish hentry">
                                            ...
                                            <div class="wrapper-content-banner ">
                                                <div class="content-banner text-left content-width-40">
                                                    ...
                                                    <div class="banner-btn-wrapper">
                                                        <div id="wd-6219e074ef57a" class="woodmart-button-wrapper text-left">
        ...
        <a href="{{ route('products.category', $cat->slug) }}" class="btn btn-color-white btn-style-bordered btn-shape-semi-round btn-size-default">
                                        ...
                                        @elseif($slider->align=='center')
                                        <div class="promo-banner-wrapper">
                                            <div id="wd-6045a19e973c5" class="promo-banner banner-vr-align-middle banner-hr-align-center banner- banner-hover-none color-scheme-light banner-btn-size-default banner-btn-style-bordered wd-display-background eux-title-playfair with-btn banner-btn-position-static cursor-pointer">
                                                ...
                                                <div class="wrapper-content-banner ">
                                                    <div class="content-banner text-center content-width-40">
                                                        <div class="banner-title-wrap banner-title-custom">
                                                            <span class="banner-subtitle subtitle-color-default subtitle-style-default woodmart-font-weight-">{{$slider->title1}}</span>
                                                            <h1 class="banner-title woodmart-font-weight-">{{$slider->title2}}</h1>
                                                        </div>
                                                        ...
                                                        <div class="banner-btn-wrapper">
                                                            <div id="wd-6219e074ef78c" class="woodmart-button-wrapper text-center">
                                                                @if($slider->type=='category' && $slider->category_id!=0)
                                                                    <a href="{{ route('products.category', $cat->slug) }}" class="btn btn-color-alt btn-style-bordered btn-shape-semi-round btn-size-default red-btnn">
                                                                        @elseif($slider->type=='brand' && $slider->brand_id!=0)
                                                                            <?php $brand=\App\Brand::find($slider->brand_id); ?>
                                                                            <a href="{{ route('products.brand',  $brand->slug) }}" class="btn btn-color-alt btn-style-bordered btn-shape-semi-round btn-size-default red-btnn">
                                                                                @elseif($slider->type=='custom')
                                                                                    <a href="{{ url($slider->link) }}" class="btn btn-color-alt btn-style-bordered btn-shape-semi-round btn-size-default red-btnn">
          ...
          <div class="banner-image wd-bg-position-center" style="background-image: url({{uploaded_asset($slider->mobile_photo) ?? " "}}); height:800px;">
                                            ...
                                            <div class="wrapper-content-banner ">
                                                <div class="content-banner text-center content-width-100">
                                                    ...
                                                    <div class="banner-inner reset-mb-10 content-size-large">
                                                        <p style="text-align: center;">{{$slider->title3}}</p>
                                                    </div>
                                                    <div class="banner-btn-wrapper">
                ...
                <div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid vc_hidden-xs vc_hidden-sm">
                    @if (count($featured_categories) > 0)
                        @foreach ($featured_categories as $key => $category)
                            ...
                            @if($category->id==2)
                                <div class="wpb_column vc_column_container vc_col-sm-6">
                                    <div class="vc_column-inner vc_custom_1614712337045">
                                        <div class="wpb_wrapper">
                                            <div class="promo-banner-wrapper">
                                                <div id="wd-603ffb00378aa" class="sht promo-banner banner-vr-align-middle banner-hr-align-center banner- banner-hover-zoom color-scheme-light banner-btn-size-default banner-btn-style-bordered wd-display-background eux-title-playfair with-btn banner-btn-position-static cursor-pointer">

                                                    <div class="main-wrapp-img">
                                                        <div class="banner-image wd-bg-position-center" style="background-image: url({{ uploaded_asset($category->banner) }}); height:300px;">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="wrapper-content-banner category-banner">
                                                        <div class="content-banner text-center content-width-100">
                                                            ...
                                                            <div class="banner-btn-wrapper banner-hide-btn-tablet banner-hide-btn-mobile">
                                                                <div id="wd-6219e074f1e28" class="woodmart-button-wrapper text-center">
                                                                    <a href="{{ route('products.category', $category->slug) }}" class="btn btn-color-white btn-style-bordered btn-shape-round btn-size-default">SHOP NOW</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="vc_row wpb_row vc_inner vc_row-fluid">
                                                    <div class="wpb_column vc_column_container vc_col-sm-6">
                                                        <div class="vc_column-inner ">
                                                            <div class="wpb_wrapper ">
                                                                <div class="promo-banner-wrapper ">
                                                                    <div id="wd-603ffb04a6e01" class="sht promo-banner banner-vr-align-middle banner-hr-align-center banner- banner-hover-zoom color-scheme-light banner-btn-size-default banner-btn-style-bordered wd-display-background eux-title-playfair with-btn banner-btn-position-static cursor-pointer">

                                                                        <div class="main-wrapp-img">
                                                                            <div class="banner-image wd-bg-position-center" style="background-image: url({{ uploaded_asset($category->banner) }}); height:280px;">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="wrapper-content-banner category-banner">
                                                                            <div class="content-banner text-center content-width-100">
                                                                                ...
                                                                                <div class="banner-btn-wrapper banner-hide-btn-tablet banner-hide-btn-mobile">
                                                                                    <div id="wd-6219e074f2366" class="woodmart-button-wrapper text-center">
                                                                                        <a href="{{ route('products.category', $category->slug) }}" class="btn btn-color-white btn-style-bordered btn-shape-round btn-size-default">SHOP NOW</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    @if($category->id==5)
                                                        <div class="wpb_column vc_column_container vc_col-sm-6">
                                                            <div class="vc_column-inner">
                                                                <div class="wpb_wrapper">
                                                                    <div class="promo-banner-wrapper">
                                                                        <div id="wd-603ffb08a9191" class="sht promo-banner banner-vr-align-middle banner-hr-align-center banner- banner-hover-zoom color-scheme-light banner-btn-size-default banner-btn-style-bordered wd-display-background eux-title-playfair with-btn banner-btn-position-static cursor-pointer">
                                                                            ...
                                                                            <div class="wrapper-content-banner category-banner">
                                                                                <div class="content-banner text-center content-width-100">
                                                                                    <div class="banner-title-wrap banner-title-custom">
                                                                                        <h3 class="banner-title woodmart-font-weight-" style="font-size: 26px;">{{ $category->getTranslation('name') }}</h3>
                                                                                    </div>
                                                                                    <div class="banner-btn-wrapper banner-hide-btn-tablet banner-hide-btn-mobile">
                                                                                        <div id="wd-6219e074f260c" class="woodmart-button-wrapper text-center">
                                                                                            <a href="{{ route('products.category', $category->slug) }}" class="btn btn-color-white btn-style-bordered btn-shape-round btn-size-default">SHOP NOW</a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
            ...
            @elseif($agent->isMobile())
            <div data-vc-full-width="true" data-vc-full-width-init="false" class="vc_row wpb_row vc_row-fluid vc_hidden-md vc_hidden-lg eux-homepage-mobile-categories">
                @if (count($featured_categories) > 0)
                    @foreach ($featured_categories as $key => $category)
                <div class="wpb_column vc_column_container vc_col-sm-6 vc_col-xs-6">
                    <div class="vc_column-inner">
                        <div class="wpb_wrapper">
                            <div class="promo-banner-wrapper">
                                <div id="wd-6045a407d4ce7" class="sht promo-banner banner-vr-align-middle banner-hr-align-center banner- banner-hover-zoom color-scheme-light banner-btn-size-default banner-btn-style-bordered wd-display-background eux-title-playfair with-btn banner-btn-position-static cursor-pointer">

                                    <div class="main-wrapp-img">
                                        <div class="banner-image wd-bg-position-center" style="background-image: url({{ uploaded_asset($category->banner) }}); height:200px;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="wrapper-content-banner category-banner">
                                        <div class="content-banner text-center content-width-100">
                                            ...
                                            <div class="banner-btn-wrapper banner-hide-btn-tablet banner-hide-btn-mobile">
                                                <div id="wd-6219e074f2d51" class="woodmart-button-wrapper text-center">
                                                    <a href="{{ route('products.category', $category->slug) }}" class="btn btn-color-white btn-style-bordered btn-shape-round btn-size-default">SHOP NOW</a>
                                                </div>
                                            </div>
                                        </div>
         ...
         <div class="title-subtitle  font-default subtitle-style-default woodmart-font-weight-400">{{ $heading_second[0] ?? " " }}</div>
                ...
                <img class="" src="{{uploaded_asset(get_setting('home_one_image2'))}}" width="134" height="19" alt="best-sellers-icon" title="best-sellers-icon" /></span>
                                    <span class="right-line"></span>
                                </div>
                                <div class="title-after_title">{!! get_setting('home_second_description') !!}</div>
                            </div>

                            <div id="section_best_selling" class="woodmart-products-tabs tabs-wd-603d4e64092a5 tabs-design-default ">
                            ...
                            @if (get_setting('home_fifth_images') != null)
                                @foreach (json_decode(get_setting('home_fifth_images'), true) as $key => $image)
                                    <div class="slide-product owl-carousel-item">
                                        <img class="info-icon image-1 " src="{{uploaded_asset($image)}}" width="241" height="204" alt="proudly-australian-made-and-owned-stamp-padding" title="" />
                                    </div>
                                @endforeach
                            @endif
                        </div>
