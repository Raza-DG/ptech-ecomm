        ...
        <div class="wrap-gallery-page">
            <div class="gallery-page-header">
                <div class="wrap-gallery-header">
                            ...
                            <div class="gallery-nav-box">
                                <div class="wrap-nav-box">
                                    ...
                                    @foreach ($galleries as $key => $gallery)
                                        <div class="gallery-nav-element js-gallery-filter active" data-filter="{{$gallery->name}}" role="button" tabindex="0">
                                            <div class="wrap-nav-element">
                                                <p class="gallery-nav-text">{{$gallery->getTranslation('name')}}</p>
                                            </div>
                                        </div>
                                    @endforeach
                                    {{-- <div class="gallery-nav-element js-gallery-filter" data-filter="hotel" role="button" tabindex="0">
                                        <div class="wrap-nav-element">
                                            <p class="gallery-nav-text">Hotel</p>
                                        </div>
                                    </div>
                                    <div class="gallery-nav-element js-gallery-rooms" role="button" tabindex="0">
                                        <div class="wrap-nav-element">
                                            <p class="gallery-nav-text">Rooms</p>
                                        </div>
                                    </div>
                                    <div class="gallery-nav-element js-gallery-restaurants" data-filter="restaurants" role="button" tabindex="0">
                                        <div class="wrap-nav-element">
                                            <p class="gallery-nav-text">Restaurants</p>
                                        </div>
                                    </div>
                                    <div class="gallery-nav-element js-gallery-filter" data-filter="spa" role="button" tabindex="0">
                                        <div class="wrap-nav-element">
                                            <p class="gallery-nav-text">Spa</p>
                                        </div>
                                    </div>
                                    <div class="gallery-nav-element js-gallery-events" data-filter="events"  role="button" tabindex="0">
                                        <div class="wrap-nav-element">
                                            <p class="gallery-nav-text">Events</p>
                                        </div>
                                    </div> --}}
                                </div>
                            </div>
                    ...
                    <div class="gallery-subnav rooms">
                        <div class="wrap-gallery-subnav">
                            ...
                            <div class="gallery-subnav-box">
                                <div class="wrap-subnav-box">
                                    ...
                                    <div class="gallery-subnav-element js-gallery-filter" data-filter="superior-king-twin-room" role="button" tabindex="0">
                                        <div class="wrap-subnav-element">
                                            <p class="gallery-subnav-text">Superior King or Twin Room  <span>/ Rooms</span></p>
                                        </div>
                                    </div>
                ...
                <div class="wrap-gallery-container">
                    ...
                    <!-- Room -->
                        ...
                        @foreach ($galleries as $gallery)
                            @foreach ($gallery->galleryitem as $key =>  $item)
                                <a href="{{uploaded_asset($item->image)}}" class="gallery-page_element" data-section="superior-king-twin-room" data-lightbox="{{$gallery->name}}" title="{{$gallery->name}}">
