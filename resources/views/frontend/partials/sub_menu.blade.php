                                                            ...
                                                            @else
                                                                ...
                                                                @if($menus2->image != null)
                                                                    <div class="elementor-element elementor-element-3f390ca elementor-widget elementor-widget-image" data-element_type="widget" data-id="3f390ca" data-widget_type="image.default">
                                                                        <div class="elementor-widget-container one-imgs">
                                                                            <!-- <a href="#"> -->
                                                                            <img alt="" class="attachment-large size-large" src="{{uploaded_asset("$menus2->image")}}"><!-- </a> -->
                                                                        </div>
                                                                    </div>
                                                                @endif
                                                            @endif
