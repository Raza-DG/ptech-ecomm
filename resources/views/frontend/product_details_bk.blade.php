                            ...
                            <div class="single-breadcrumbs-wrapper">
														<div class="single-breadcrumbs">
															<nav class="woocommerce-breadcrumb">
																...
																<a href="{{route('search')}}" class="breadcrumb-link ">Products</a>
																<span class="breadcrumb-last"> {{ $detailedProduct->getTranslation('name') }}</span>
															</nav>
														</div>
													</div>

                            <h1 class="mb-2 fs-20 fw-600" style="font-weight: 600 !important;
    font-size: 34px !important;">
                            ...
                            @else
                                @if(home_price($detailedProduct) != home_discounted_price($detailedProduct))
                                    ...
                                    <div class="row no-gutters my-2 d-none">
                                        <div class="col-sm-2">
                            ...
                            <form id="option-choice-form">
                                ...
                                <div class="row no-gutters pb-3 d-none" id="chosen_price_div">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="product-price">
										 ...
										 <div class="stock">
															<img alt="" src="{{ static_asset('assets-ecom/images/icons/download.png') }}" width="30px"> <a href="#gotoTabs"  >Download Data Sheet</a>
														</div>
                                ...
                                <div class="woodmart-wishlist-btn wd-action-btn wd-wishlist-btn wd-style-text">
														<a href="javascript:;" onclick="addToWishList({{ $detailedProduct->id }})" >{{ translate('Add to wishlist')}}</a>
                            ...
                            <div class="mt-3">
                                ...
                                <button type="button" class="btn btn-secondary out-of-stock fw-600 d-none" disabled>
								  ...
								  @if (get_setting('conversation_system') == 1)
                                        ...
                                        <button class="btn btn-primary buy-now fw-600" onclick="show_chat_modal()">{{ translate('Enquire Now')}}</button>
