            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">All PageCategory / Create PageCategory</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div class="card card-flush">
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                <div class="col text-md-left">
                                    <h5 class="mb-md-0 h6">{{ translate('PageCategory') }}</h5>
                                </div>
                                <div class="d-flex align-items-center">
                                    <a class="btn btn-primary" href="{{ route('pagecategory.create') }}">Add New Page Category</a>
                                </div>
                                <div class="col-md-2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                                            href="{{ route('pagecategory.edit', ['id' => $category->id, 'lang' => env('DEFAULT_LANGUAGE')]) }}"
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            data-href="{{ route('pagecategory.destroy', $category->id) }}"
