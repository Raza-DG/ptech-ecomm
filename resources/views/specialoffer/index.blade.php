            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">All Special Offers / Create Special Offers</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div class="card card-flush">
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                <div class="col text-md-left">
                                    <h5 class="mb-md-0 h6">{{ translate('Special Offers') }}</h5>
                                </div>
                                <div class="d-flex align-items-center">
                                    <a class="btn btn-primary" href="{{ route('specialoffer.create') }}">Add New SpecialOffer</a>
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="card-body">
                                    ...
                                    <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                        ...
                                        <tbody>
                                            @foreach ($special_offers as $key => $offer)
                                                ...
                                                <tr>
                                                    <td>{{ $key+1 }}</td>
                                                    <td>{{ $offer->getTranslation('title') }}</td>
                                                    {{-- <td>{{ $offer->getTranslation('description') }}</td> --}}
                                                    <td>
                                                        <img src="{{ uploaded_asset($offer->image) ?? static_asset('assets/img/placeholder-rect.jpg') }}" alt="{{ translate('Special Offer image') }}" class="h-50px">
                                                    </td>
                                                        ...
                                                        <label
                                                            ...
                                                            <span
                                                                ...
                                                                <input class="form-check-input" onchange="updatestatus(this)" type="checkbox"
                                                                    {{ $offer->status == 1 ? 'checked' : '' }} value="{{ $offer->id }}">
                                                            </span>
                                                        </label>
                                                    </td>
                                                    <td class="text-right">
                                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                                            href="{{ route('specialoffer.edit', ['specialoffer' => $offer, 'lang' => env('DEFAULT_LANGUAGE')]) }}"
                                                            title="{{ translate('Edit') }}">
                                                            <i class="las la-edit"></i>
                                                        </a>
                                                        <a href="#"
                                                            class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                                                            data-href="{{ route('specialoffer.destroy', $offer->id) }}"
                                ...
                                <div class="aiz-pagination">
                                    {{ $special_offers->appends(request()->input())->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
