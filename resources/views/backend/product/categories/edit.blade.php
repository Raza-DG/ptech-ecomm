                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-5 fv-row">
                                    ...
                                    <input type="text" placeholder="{{ translate('Name') }}" id="name" name="name"
                                        class="form-control mb-2" value="{{ $category->getTranslation('name', $lang) }}"
                                        required>
                                ...
                                <div class="fv-row mb-2">
                                    ...
                                    <select class="form-select mb-2" data-control="select2" data-hide-search="false"
                                        ...
                                        @foreach ($categories as $acategory)
                                            <option value="{{ $acategory->id }}" @if ($category->parent_id == $acategory->id) selected @endif>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="text-muted fs-7">
                                    {{ translate('These images are visible in Category Page Icon. Use 64x64 sizes images.') }}
                                </div>
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10">
                                    ...
                                    <textarea name="meta_description" rows="5"
                                        class="form-control mb-2">{{ $category->meta_description }}</textarea>
                                    <!--end::Editor-->
                                    <!--begin::Description-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <input type="number" name="order_level" class="form-control mb-2" id="order_level"
                                    placeholder="{{ translate('Order Level') }}" value="{{ $category->order_level }}">
