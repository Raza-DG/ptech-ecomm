        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Gallery Subcategory Edit</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div id="kt_content_container" class="container-xxl">
                ...
                @foreach (\App\Models\Language::all() as $key => $language)
                    <li class="nav-item">
                        <a class="nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3"
                            href="{{ route('gallery.edit', ['id' => $gallery->id, 'lang' => $language->code]) }}">
            ...
            <div class="col-md-12">
                <div class="card card-flush">
                    ...
                    <div class="card-body">
                        <form action="{{ route('gallery.subcategory.update',$gallery->id) }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="parent_id" id="" class="form-control" required>
                                    ...
                                    @foreach(App\Models\Gallery::where('parent_id',0)->get() as $item)
                                        <option  value="{{ $item->id }}" @if($gallery->parent_id == $item->id) selected @endif>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" placeholder="{{ translate('Title') }}" name="title"
                                    class="form-control" value="{{$gallery->getTranslation("title",$lang)}}" autofocus required>
                            </div>
                            <div class="form-group mb-3">
                                <label for="name">{{ translate('Name') }}</label>
                                <input type="text" placeholder="{{ translate('Name') }}" name="name" value="{{$gallery->getTranslation("name",$lang)}}"
                                    class="form-control">
                            </div>
