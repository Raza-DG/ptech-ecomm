            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">All Gallery / Subcategory Gallery</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div class="card card-flush">
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                ...
                                <div class="d-flex align-items-center">
                                    <a class="btn btn-primary" href="{{ route('gallery.subcategory.create') }}">Add New Subcategory Gallery</a>
                                </div>
                                <div class="col-md-2">
                                        ...
                                        <tbody>
                                            @foreach ($galleries as $key => $gallery)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $gallery->parent->getTranslation('name') }}</td>
                                                    <td>{{ $gallery->getTranslation('name') }}</td>
                                                    <td class="text-right">
                                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                                            href="{{ route('gallery.subcategory.edit', ['id' => $gallery->id, 'lang' => env('DEFAULT_LANGUAGE')]) }}"
