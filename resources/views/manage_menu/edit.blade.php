...
<div class="row">
    <div class="col-lg-12 mx-auto">
        <div class="card">
            <div class="card-body p-0" style="overflow: auto;max-height: calc(100vh - 50px);">
                ...
                <form class="p-4" action="{{ route('menu.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-3">
                                <div class="fv-row mt-5 mb-2">
                                    <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid mb-5">
                                        <span class="form-check-label ms-0 fw-bolder fs-6 text-gray-700">{{translate('Full Image')}}</span>
                                        <span class="form-check-label ms-0 fw-bolder fs-6 text-gray-700 ps-5">
                                            <input class="form-check-input" type="checkbox" name="full_image" value="1" @if($menu->full_image == '1') checked @endif>
                                        </span>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea class="aiz-text-editor" id="text-editor" name="description">{{ $menu->description }}</textarea>
                        </div>
                    </div>
