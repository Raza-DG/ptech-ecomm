            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">All Gallery Item / Create Gallery Item</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <div class="card card-flush">
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                <div class="col text-md-left">
                                    <h5 class="mb-md-0 h6">{{ translate('Gallery Item') }}</h5>
                                </div>
                                <div class="d-flex align-items-center">
                                    <a class="btn btn-primary" href="{{ route('galleryitem.create') }}">Add New GalleryItem</a>
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach ($gallery_items as $key => $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $item->gallery->getTranslation('name') }}</td>
                                                    <td>
                                                        <img src="{{ uploaded_asset($item->image) ?? static_asset('assets/img/placeholder-rect.jpg') }}" alt="{{ translate('Special Offer image') }}" class="h-50px">
                                                    </td>

                                                    <td class="text-right">
                                                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                                            href="{{ route('galleryitem.edit', ['id' => $item->id, 'lang' => env('DEFAULT_LANGUAGE')]) }}"
                                                            title="{{ translate('Edit') }}">
                                                            <i class="las la-edit"></i>
                                                        </a>
                                                        <a href="#"
                                                            class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                                                            data-href="{{ route('galleryitem.destroy', $item->id) }}"
                                ...
                                <div class="aiz-pagination">
                                    {{ $gallery_items->appends(request()->input())->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
