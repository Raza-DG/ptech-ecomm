...
class RouteServiceProvider extends ServiceProvider
{
  ...
  public function map()
  {
     ...
     $this->testimonialWebRoutes();

     $this->roomWebRoutes();

     $this->specialofferWebRoutes();

     $this->contactWebRoutes();

     $this->galleryWebRoutes();

     $this->pagecategoryWebRoutes();
  ...
  /**
   * Define the "testimonial" routes for the application.
   *
   * These routes all receive session state, CSRF protection, etc.
   *
   * @return void
   */
  protected function testimonialWebRoutes()
  {
    if (addon_is_activated('testimonial')){
        Route::middleware('web')
           ->namespace($this->namespace)
  ...
  /**
   * Define the "rooms" routes for the application.
   *
   * These routes all receive session state, CSRF protection, etc.
   *
   * @return void
   */
  protected function roomWebRoutes()
  {
    // if (addon_is_activated('room')){
        Route::middleware('web')
           ->namespace($this->namespace)
    ...
    /**
   * Define the "specialofferWebRoutes" routes for the application.
   *
   * These routes all receive session state, CSRF protection, etc.
   *
   * @return void
   */
    protected function specialofferWebRoutes()
    {
        //if (addon_is_activated('specialoffer')){
            Route::middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/specialoffer.php'));
        //}
    }

     /**
   * Define the "contact us" routes for the application.
   *
   * These routes all receive session state, CSRF protection, etc.
   *
   * @return void
   */
    protected function contactWebRoutes()
    {
        //if (addon_is_activated('specialoffer')){
            Route::middleware('web')
            ->namespace($this->namespace)
    ...
    protected function galleryWebRoutes()
    {
        //if (addon_is_activated('specialoffer')){
            Route::middleware('web')
            ->namespace($this->namespace)
    ...
    protected function pagecategoryWebRoutes()
    {
        //if (addon_is_activated('specialoffer')){
            Route::middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/page_category.php'));
        //}
    }
}
