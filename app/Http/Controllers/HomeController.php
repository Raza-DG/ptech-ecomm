...
//        $categories = Category::where('level', 0)->orderBy('name', 'asc')->get();
    ...
    public function special()
    {
        ...
        return view('frontend.special',compact('specialoffers'));
    }
    ...
    {
        return view('frontend.guest_review');
    }
    ...
    public function contact_store(Request $request)
    {
        ...
        $conatct->surname = $request->surname;
        $conatct->name = $request->name;
        $conatct->phone = $request->phone;
        $conatct->message = $request->message;
        $conatct->typeofquery = $request->typeofquery;
        $conatct->privacypolicy = $request->privacypolicy;
        $conatct->update = $request->update;
        $conatct->save();
