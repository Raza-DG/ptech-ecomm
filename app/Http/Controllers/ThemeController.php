...
class ThemeController extends Controller
{
    ...
    public function activation(Request $request)
    {
        ...
        if ($request->status == true) {
            ...
            $str = file_get_contents(base_path('public/themes/'. $dir[0] . '/config.json'));
            // dd($str);
            ...
            if (!empty($json['files'])) {
                ...
                foreach ($json['files'] as $file) {
                    $this->xcopy(base_path('public/themes/' . $dir[0] .'/'. $file['root_directory']), base_path($file['update_directory']));
                }
            }
            ...
            if (file_exists(base_path('resources/views/frontend'))) {
                ...
                $this->deleteDir(base_path('public/assets/frontend/assets_new'));
            } else {
                mkdir(base_path('resources/views/frontend'));
                mkdir(base_path('public/assets/frontend/assets_new'));
            }
            return 0;
        }
    }
